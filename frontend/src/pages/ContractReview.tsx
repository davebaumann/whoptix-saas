              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-6 max-h-96 overflow-y-auto">
                <div className="space-y-4 text-sm text-gray-700">
                  <section>
                    ...
                    <p className="mb-2">
                      This summary is provided to help you understand the key points. The full agreement below is legally binding.
                    </p>
                    <ul className="list-disc list-inside space-y-1">
                      <li>Annual subscriptions only, with automatic twelve month renewals</li>
                      <li>Thirty days written notice required to cancel renewal</li>
                      <li>Late cancellation triggers a two month pro rated fee</li>
              ...
              <div className="border-t border-gray-200 pt-6">
                <div className="flex items-start">
                  ...
                  <label htmlFor="agree-terms" className="ml-3 text-sm text-gray-700">
                    I have read and agree to the Whoptix Service Agreement and{' '}
