        ...
        public async Task<ActionResult<IEnumerable<LowStockThresholdDto>>> GetThresholds(int customerId)
        {
            var thresholds = await _context.LowStockThresholds
                ...
                .Select(lst => new LowStockThresholdDto
                {
                    ...
                    ProductName = lst.Product != null ? lst.Product.Name ?? string.Empty : string.Empty,
                    ProductSku = lst.Product != null ? lst.Product.Sku ?? string.Empty : string.Empty,
                    LocationId = lst.LocationId,
                    LocationName = lst.Location != null && lst.Location.Name != null ? lst.Location.Name : "All Locations",
